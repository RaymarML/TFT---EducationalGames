<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Game.master" AutoEventWireup="true" CodeBehind="Anagrama.aspx.cs" Inherits="EducationalGames.Views.Anagrama" %>
<%@ MasterType VirtualPath="~/MasterPages/Game.master" %>

<asp:Content ID="GameStyle" ContentPlaceHolderID="GameStyle" runat="server">
    <link rel="stylesheet" href="/Assets/LetterSort.css">
</asp:Content>

<asp:Content ID="GameTitle" ContentPlaceHolderID="GameTitle" runat="server">
<h1 class="game-title">Anagrama</h1>
</asp:Content>

<asp:Content ID="GameDescription" ContentPlaceHolderID="GameDescription" runat="server">
<h2 class="game-description">Órdena las letras para formar la palabra.</h2>
</asp:Content>
...
<asp:Content ID="GameScripts" ContentPlaceHolderID="GameScripts" runat="server">
    <script src="/Scripts/GameScripts/Providers/LetterSortProvider.js"></script>
    ...
    <script>
        let gameManager = new GameManager(
            new LetterSortProvider(),
            new Settings(),
            new Timer(),
        );
        let gameFactory = new SorteableSetFactory();
        gameManager.game = gameFactory.getSorter("letter", gameManager.getGameManagerCallBack());
